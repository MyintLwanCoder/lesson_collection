...
if(isset($_POST['register'])){
    ...
    if($result){
      header("location: login.php");
        ...
        echo "<script>alert(contact faild)</script>";
    }
}
?>
<!DOCTYPE html>
                  ...
                  <div class="col-md-5 mr-auto">
                    ...
                    <form method="POST" action="">
                      ...
                      <div class="text-center">
                        <input type="submit" name="register" class="btn btn-primary btn-round mt-4" value="Register">
                      </div>
                    </form>
                  </div>
                </div>
      ...
      <footer class="footer">
        <div class="container">
          <nav class="float-left">
            <ul>
              <p>Enter you Register Account</p>
            </ul>
          </nav>
