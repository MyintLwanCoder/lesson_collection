...
if(isset($_POST['answer'])){
  $family_about = $_POST['family_about'];
  $date = $_POST['date'];
  $sql = "INSERT INTO `chapter_2`(`family_about`, `date`) VALUES ('$family_about','$date')";
  $result = mysqli_query($con,$sql);
  if($result){
   header("location: 2_chapter_answers.php");
  }else{
            ...
            <div class="col-md-12">
              <div class="card ">
                <div class="card-header card-header-rose card-header-icon">
                  ...
                  <h4 class="card-title">Answer the question  <a class="btn btn-success" href="2_chapter_answers.php">Look You Answers</a></a></h4>
                </div>
                <div class="card-body ">
                  <form method="POST" action="">
                    <center><h2><strong>Write about your Family</strong></h2></center>
                    <div class="form-group bmd-form-group">
                    <textarea  cols="160" rows="10" name="family_about"></textarea>
                    </div>
                    <div class="form-group bmd-form-group">
                  ...
                  <a  href="../answer/chapter_2.php" class="btn btn-success">Show Answer</a>
                  </form>
                </div>
              </div>
            </div>
