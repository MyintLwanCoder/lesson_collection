...
$data = mysqli_query($con, "SELECT * FROM `librain` WHERE `email` = '$libraian_login'");
            ...
            <div class="rightside-header">
                ...
                <div class="header-section" id="user-headerbox">
                    <div class="user-header-wrap">
                        ...
                        <div class="user-info">
                            <span class="user-name"><?php echo ucwords($libraian_info['firstname']).' '.ucwords($libraian_info['lastname']); ?></span>
                    ...
                    <div class="nano-content">
                        <nav>
                            <ul class="nav nav-left-lines" id="main-nav">
                                ...
                                <li class="<?php $page == 'test.php' ? 'active item': '' ?>"><a href="student.php"><i class="fa fa-users" aria-hidden="true"></i><span>Student</span></a></li>
                                <li class="has-child-item close-item <?php $page == 'add_book.php' ? 'open item': '' ?><?php $page =='manage_book.php' ? 'open item': '' ?>">
                                    <a><i class="fa fa-book" aria-hidden="true"></i><span>Books</span></a>
                                    <ul class="nav child-nav level-1">
                                        <li class=" <?php $page == 'add_book.php' ? 'active item': '' ?>"><a href="add_book.php">Add Book</a></li>
                                        <li class=" <?php $page == 'manage_book.php' ? 'active item': '' ?>"><a href="manage_book.php">Manage Book</a></li>
                                    </ul>
                                </li>
                                <li class="<?php $page == 'issue-book.php' ? 'active item': '' ?>"><a href="issue-book.php"><i class="fa fa-book" aria-hidden="true"></i><span>Issue Book</span></a></li>
                                <li class="<?php $page == 'issue-book.php' ? 'active item': '' ?>"><a href="return_book.php"><i class="fa fa-book" aria-hidden="true"></i><span>Return Book</span></a></li>
                                <!--UI ELEMENTENTS-->
                            </ul>
                        </nav>
                    </div>
