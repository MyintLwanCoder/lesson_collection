 ...
 <div class="container-fluid">
	...
	<div class="row">
		<div class="col-md-3">
				   ...
				   <div class="card-body">
					   <p class="card-text">No. of total users:<?php echo get_book_count();?></p>
		...
		<div class="col-md-3">
				   ...
				   <div class="card-body">
					   <p class="card-text">No. of availabale Books:<?php echo get_user_count();?></p>
		...
		<div class="col-md-3">
				   ...
				   <div class="card-body">
					   <p class="card-text">No. of bookd's category:<?php echo get_category_count();?></p>
		...
		<div class="col-md-3">
				   ...
				   <div class="card-body">
					   <p class="card-text">No. of availabale Authors:<?php echo get_author_count();?></p>
